...
# translation
SOURCES = tilemapscalelevels.py ui_tilemapscalelevels.py __init__.py tilemapscalelevelsdialog.py
#TRANSLATIONS = i18n/tilemapscalelevels_en.ts
TRANSLATIONS = 
...
PY_FILES = tilemapscalelevels.py tilemapscalelevelsdialog.py __init__.py
